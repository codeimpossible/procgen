...
namespace Solarsystem.Generation
{
    public static partial class Generator {
        public static Dictionary<StarClassification, CelestialChromacity> ChromacityPalette = new Dictionary<StarClassification, CelestialChromacity>() {
            { StarClassification.O, ( 49,  93, 205) },
            { StarClassification.B, (115, 223, 242) },
            { StarClassification.A, (234, 234, 232) },
            { StarClassification.F, (235, 255, 139) },
            { StarClassification.G, (292, 197,  57) },
            { StarClassification.K, (209, 116,  65) },
            { StarClassification.M, (199,  82,  57) },
        };
        ...
        public static Star CreateStar(StarClassification classification) {
            return new Star() {
                ...
                Chromacity = ChromacityPalette[classification],
                Albedo = 1f,
                RotationTime = 1f,
            };
        }
