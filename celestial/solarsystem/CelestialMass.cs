...
public struct CelestialMass {
    ...
    public float SolarMass {
        get => _massOfEarth * Constants.EarthSolarMassRatio;
        set => _massOfEarth = value / Constants.EarthSolarMassRatio;
    }
    ...
    public float MassOfJupiter {
        get => _massOfEarth * Constants.EarthSolarMassRatio / Constants.JupiterSolarMassRatio;
        set => _massOfEarth = value * Constants.JupiterSolarMassRatio / Constants.EarthSolarMassRatio;
    }
